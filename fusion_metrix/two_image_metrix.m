...
switch metrix_name
    ...
    case 'hpsim'
         metrix_value = metrix_mux( reference_image, distorted_image,metrix_name);
    case 'nmin'
        metrix_value0 = mutual_information(reference_image, distorted_image);
        metrix_value1 = one_image_metrix(reference_image,'sen');
        metrix_value2 = one_image_metrix(distorted_image,'sen');
        metrix_value = metrix_value0./(metrix_value1 + metrix_value2);
    case 'q0i'
